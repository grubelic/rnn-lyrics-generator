...
\begin{table}[ht]
\caption{The Lyric Assessor scores depending on model architecture and training time} % title of Table
\centering % used for centering table
\begin{tabular}{c c c c} % centered columns (4 columns)
\hline\hline %inserts double horizontal lines
Epochs & SimpleRNN & SimpleLSTM & BiLSTM\\ [0.5ex] % inserts table
%heading
